...
- TypeScript 5.x, Node.js ≥ 20 + Hono (HTTP), Drizzle ORM, Better Auth (admin context), grammY (Telegram admin), existing PaymentGateway por (014-coupon-affiliate)
- PostgreSQL 16 (Drizzle migrations) (014-coupon-affiliate)
...
## Recent Changes
- 014-coupon-affiliate: Added TypeScript 5.x, Node.js ≥ 20 + Hono (HTTP), Drizzle ORM, Better Auth (admin context), grammY (Telegram admin), existing PaymentGateway por
